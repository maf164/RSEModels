function [bestfval, fit] = raceqraab(data,s)
...
% 
% modelav = raceCDF(0:.001:1,[fit(1) fit(2)],[fit(3);fit(4)]);
% 
% plot(0:.001:1,modela);
% plot(0:.001:1,modelv);
...
ex1 = maxNormCDF(quants(13:18), [mu1 mu2], [sigma1 sigma2], 0 );
...
[AIC BIC] = aicbic(log,4,NA+NV+NAV);
cost = BIC;
end
