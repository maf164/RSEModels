function [bestfval, fit] = raceqrho(data,s)
...
param = [param(1) param(2) param(3) param(4) param(6)];
mu1 = param(1);
mu2 = param(2);
sigma1 = param(3);
sigma2 = param(4);
...
% 
% modelav = raceCDF(0:.001:1,[fit(1) fit(2)],[fit(3);fit(4)],fit(5));
% 
% plot(0:.001:1,modela);
% plot(0:.001:1,modelv);
...
ex1 = maxNormCDF(quants(13:18), [mu1 mu2], [sigma1 sigma2], rho );
